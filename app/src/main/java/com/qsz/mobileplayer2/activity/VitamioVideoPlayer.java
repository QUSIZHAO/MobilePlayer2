...
import com.qsz.mobileplayer2.view.VitamioVideoView;
...
/**
 * 万能播放器
 * Created by QSZ on 2018/7/11 14:25
 *
 * @author QSZ
 */
public class VitamioVideoPlayer extends Activity implements View.OnClickListener {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SHOW_SPEED:
                    // 1.得到网络速度
                    String netSpeed = mUtils.getNetSpeed(VitamioVideoPlayer.this);
    ...
    private void setData() {
        if (mMediaItems != null && mMediaItems.size() > 0) {
            ...
            Toast.makeText(VitamioVideoPlayer.this, "美女你没有传递数据", Toast.LENGTH_SHORT).show();
        }
        setButtonState();
    }
