...
import com.qsz.mobileplayer2.adapter.NetVideoPagerAdapter;
...
import com.qsz.mobileplayer2.view.XListView;
...
/**
 * 网络视频页面
 * Created by QSZ on 2018/7/9 11:12
 */
public class NetVideoPager extends BasePager {
    ...
    public View initView() {
        ...
        mXListView.setXListViewListener(new MyIXListViewListener());
        return view;
    }
    ...
    private void processData(String json) {
        if (!isLoadMore) {
            ...
            // 要把得到更多的数据，添加到原来的集合中
            isLoadMore = false;
            mMediaItems.addAll(parseJson(json));
            // 刷新适配器
    ...
    private void showData() {
        ...
        if (mMediaItems != null && mMediaItems.size() > 0) {
            // 有数据
            // 设置适配器
            mAdapter = new NetVideoPagerAdapter(mContext, mMediaItems);
    ...
    private void onLoad() {
        ...
        mXListView.setRefreshTime("更新时间：" + getSystemTime());
    }
            ...
            if (jsonArray != null && jsonArray.length() > 0) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (jsonObjectItem != null) {
                        ...
                        String movieName = jsonObjectItem.optString("moveName");
