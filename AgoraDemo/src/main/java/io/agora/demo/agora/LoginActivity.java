...
public class LoginActivity extends BaseActivity {
    ...
    private void initViews() {
        ...
        this.mVendorKey.setText(getSharedPreferences(getClass().getName(), Context.MODE_PRIVATE).getString(ChannelActivity.EXTRA_VENDOR_KEY, "8180e1a6da1c46cc8785aa9000c70e80"));
        this.mChannelID.setText(getSharedPreferences(getClass().getName(), Context.MODE_PRIVATE).getString(ChannelActivity.EXTRA_CHANNEL_ID, "888888"));
